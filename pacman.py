...
def runGenetic(layout, ghosts, display, population, generations, mutation, crossover):
    ...
    def geneticFitnessFn(individual):
        ...
        representing NN weights for the GeneticAgent, this method will run a game
        using a GeneticAgent with those weights, and report the score.
        
        The fitness value is thus the score of a game run with the individual.
        """
        currentControllerNN = PacmanControllerModel(weights=individual)
        currentPacman = GeneticAgent(policy=currentControllerNN)
